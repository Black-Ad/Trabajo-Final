        ...
        btnGuarda.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!txtNombre.getText().toString().equals("") ) {
                    correcto = dbContactos.editarContacto(id, txtNombre.getText().toString(), txtCorreo.getText().toString());

                    if(correcto){
                        Toast.makeText(EditarActivity.this, "Tarea Modificada", Toast.LENGTH_LONG).show();
                        verRegistro();
                    } else {
