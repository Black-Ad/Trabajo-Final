...
public class DbContactos extends DbHelper {
    ...
    public ArrayList<Contactos> mostrarContactos() {
        ...
        if (cursorContactos.moveToFirst()) {
            do {
                ...
                contacto.setCorreo_electornico(cursorContactos.getString(2));
    ...
    public boolean editarContacto(int id, String nombre, String correo_electronico) {
        ...
        try {
            db.execSQL("UPDATE " + TABLE_CONTACTOS + " SET nombre = '" + nombre + "', correo_electronico = '" + correo_electronico + "' WHERE id='" + id + "' ");
            correcto = true;
        } catch (Exception ex) {
            ex.toString();
            correcto = false;
